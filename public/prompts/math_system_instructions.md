...
5.  **Xử lý Biểu thức và Công thức Toán học:**
    ...
    *   **Tái tạo Đồ họa Toán học & Hình học bằng SVG (CHUẨN KHOA HỌC & ĐỘ CHÍNH XÁC CAO):**
        ...
        *   **Nhãn và Ký hiệu (Labeling):**
            ...
            *   **Ký hiệu Toán học:** Ưu tiên dùng Unicode chuyên dụng hoặc cấu trúc `baseline-shift` cho chỉ số dưới ($x_0$) và chỉ số trên ($x^2$). Bắt buộc dịch mọi chú thích sang tiếng Việt.
